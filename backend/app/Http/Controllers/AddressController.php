...
class AddressController extends Controller
{
    public function index(){
        try {
            ...
            return response()->json(['status' => 'success', 'data' => $provinces->sortBy('name')->values()->all()], 200);
        } catch (\Throwable $th) {
    ...
    public function cities($id){
        try {
            ...
            return response()->json(['status' => 'success', 'data' => $cities->sortBy('name')->values()->all()], 200);
        } catch (\Throwable $th) {
            return response()->json(['status' => 'error', 'message' => $th->getMessage()], 400);
        }
    }
    public function districts($id){
        try {
            ...
            return response()->json(['status' => 'success', 'data' => $district->sortBy('name')->values()->all()], 200);
        } catch (\Throwable $th) {
            return response()->json(['status' => 'error', 'message' => $th->getMessage()], 400);
        }
    }
