    ...
    <>
      ...
      >
        ...
        <ModalBox id="modal-add">
          <h3 className="font-bold text-lg mb-4 flex justify-between">Tambah kategori pengeluaran <SelectedClinicBadge></SelectedClinicBadge></h3>
        ...
        <ModalBox id="modal-put">
          <h3 className="font-bold text-lg mb-4">Edit kategori pengeluaran</h3>
