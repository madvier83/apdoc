            ...
            <div class="modal-body">
                ...
                <div class="input-icon-group col-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="seed" name="seed" value="{{$data->seed}}" min="1" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="cta_button" name="cta_button" value="{{$data->cta_button}}" required>
                        </div>
                        <div class="form-group">
                            <label for="target_url">Target Url ( Optional )</label>
                            <input type="text" class="form-control" id="target_url" name="target_url" value="{{$data->target_url}}" required>
                        </div>
                    </div>
                </div>
            </div>
