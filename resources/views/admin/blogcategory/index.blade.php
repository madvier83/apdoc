...
@section('title', 'Dashboard - Category blog')
@push('custom-css')
...
@section('adminContent')
                ...
                <div class="col-md-5 d-flex justify-content-end h-md-down">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb no-padding bg-trans mb-0">
                            ...
                            <li class="breadcrumb-item active">Category Blog</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        @endif
            <div class="bg-white table-responsive rounded shadow-sm pt-3 pb-3 mb-30">
                <div class="d-flex justify-content-between">
                        <h6 class="pl-3 pr-3 text-capitalize font400 mb-20">Category blog</h6>
                ...
                <table id="datatablecategory" class="table mb-0 table-striped" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Name</th>
                    ...
                    @foreach($models::all() as $item)
                        <tr>
                            ...
                            <div class="row d-flex justify-content-first">
                                ...
                                {{--<form method="POST" action="{{route('admin.blogcategory.delete',['id'=>$item->id])}}">
                                    @method('delete')
                                    @csrf
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header">
            ...
            <div id="formArea">
            <form id="addCategoryForm" action="{{ route('admin.blogcategory.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    @push('custom-js')
        ...
        <script>
            ...
            swal({
                ...
                if(result){
                    $.ajax({
                        url: `{{ url('/dashboard/blog-category/delete/${id}') }}`,
                        type: "DELETE",
                        dataType: "JSON",
                        data: {
                            "_token": "{{ csrf_token() }}"
            ...
            <div class="modal-footer d-flex justify-content-center m-0">
                ...
                $.get("{{ url("dashboard/blog-category/show") }}/" + id, {}, function(data, status) {
                    console.log(status);
